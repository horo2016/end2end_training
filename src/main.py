...
def parse_args():
    ...
    # training settings
    parser.add_argument('--epochs',       type=int,   default=10,            help='number of epochs to train')#60
    ...
    parser.add_argument('--model_name',   type=str,   default="my",      help='model architecture to use [nvidia, lenet]')
...
def main():
    ...
    if args.resume:
        ...
        checkpoint = torch.load("model-11.h5",
